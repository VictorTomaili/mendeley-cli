...
export function register(program) {
  ...
  Steps (printed in the terminal):
    ...
    .action(async (_args, flags, out) => {
      ...
      process.stdout.write('Mendeley login — PKCE authorisation-code flow\n');
      process.stdout.write('\n');
      process.stdout.write('  Step 1  Open this URL in your browser and complete the\n');
      process.stdout.write('          Mendeley login and authorisation:\n');
      process.stdout.write('\n');
      ...
      process.stdout.write('\n');
      process.stdout.write('  Step 3  Copy the ENTIRE URL from the browser address bar.\n');
      process.stdout.write('\n');
      process.stdout.write('  Step 4  Paste it below:\n');
      process.stdout.write('\n');
      process.stdout.write(`  Redirect URL (http://${redirectHost}/…) > `);
  ...
  preserved.`,
    ...
    .action(async ([key, value], _flags, out) => {
      ...
      writeFileSync(path, JSON.stringify(sanitizeCredentials(creds), null, 2), { mode: 0o600 });

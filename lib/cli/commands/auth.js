...
export function register(program) {
  ...
  auth
    ...
    .longDescription(`Prints the authorisation URL and prompts you to paste the
  ...
  auth
    ...
    .longDescription(`If a previous \`mendeley auth login\` (or \`auth url\`) was started
  ...
  auth
    ...
    .longDescription(`Generates the authorisation URL and saves the PKCE verifier to

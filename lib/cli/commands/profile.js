...
export function register(program) {
  const cmd = program
    ...
    .longDescription(`Profiles are public-facing records of Mendeley users.  Use
  ...
  cmd
    ...
    .longDescription(`Return the full profile of the currently authenticated user.
  ...
  cmd
    ...
    .longDescription(`Fetch a public profile by UUID.  Useful for resolving

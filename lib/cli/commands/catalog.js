...
export function register(program) {
  const cmd = program
    ...
    .longDescription(`The catalog is the public, global index of papers and books
  ...
  cmd
    ...
    .longDescription(`Fetch a single catalog document by its UUID.  Use
  ...
  cmd
    ...
    .longDescription(`Resolve a DOI (e.g. \`10.1038/nature12373\`) to a catalog
  ...
  cmd
    ...
    .longDescription(`Resolve any of the supported identifier types to a catalog
  ...
  cmd
    ...
    .longDescription(`Useful when you have only partial metadata: a partial DOI, a
  ...
  catalog document and a confidence score between 0 and 1.`)
    ...
    .example('mendeley catalog lookup --title "Attention is all you need" --authors Vaswani --year 2017')
    .action(async (_args, flags, out) => {
      const session = await buildSession();
  ...
  cmd
    ...
    .longDescription(`Search across the global catalog.  Returns a single page of
  ...
  cmd
    ...
    .longDescription(`Same shape as \`mendeley documents advanced-search\` but

...
export function register(program) {
  const cmd = program
    ...
    .longDescription(`Annotations live on documents (or more precisely, on files
  ...
  cmd
    ...
    .longDescription(`Enumerate annotations, optionally filtered by --document
  ...
  cmd
    ...
    .longDescription(`Patch an annotation with new fields.  Pass --data (inline

...
export function register(program) {
  const docs = program
    ...
    .longDescription(`CRUD over the documents in your Mendeley library.  Each
  ...
  docs
    ...
    .longDescription(`Returns a single page of documents (default 20, override with
  ...
  docs
    ...
    .longDescription(`Fetch full metadata for a single document.  The \`--view\`
  ...
  docs
    ...
    .longDescription(`Search the user library using a single free-form query string.
  ...
  docs
    ...
    .longDescription(`Search by individual fields.  All flags are optional; omit
  ...
  docs
    ...
    .longDescription(`Create a new document in the library.  The body can be supplied
  ...
  docs
    ...
    .longDescription(`Create a new document from a file on disk.  The file's MIME type
  ...
  docs
    ...
    .longDescription(`Update an existing document with a partial body.  Only the
  ...
  docs
    ...
    .longDescription(`Remove a document from the library permanently.  This is NOT
  ...
  docs
    ...
    .longDescription(`Move a document to the trash, from which it can be restored via
  ...
  docs
    ...
    .longDescription(`Upload a file from disk and attach it to the given document.
  ...
  docs
    ...
    .longDescription(`Create a sticky-note style annotation containing the given
  ...
  docs
    ...
    .longDescription(`List all annotations (highlights, notes, sticky notes) attached
  ...
  list of annotation ids.`)
    ...
    .action(async ([id], flags, out) => {
      ...
      const items = flags.all
        ? await collect(session.annotations.iter({ document_id: id, pageSize: parseInt(flags.limit, 10) }))
        : await (async () => {
            const p = await session.annotations.list({ document_id: id, pageSize: parseInt(flags.limit, 10) });
            return p.items;
          })();
      out.write(items);
    });
  ...
  docs
    ...
    .longDescription(`Return the metadata of all files attached to the given document.
  ...
  docs
    ...
    .longDescription(`Convert a document's \`bib\` view to a single BibTeX entry.

...
/**
 * Parse and validate a --limit / page-size value (#15).
 *
 * Returns a positive integer, or undefined when the input is empty
 * (so the API default applies). Throws an ArgvError for 0, negative,
 * or non-numeric values so the user gets a clean CLI error instead
 * of a confusing default-page or "short flags" error.
 *
 * @param {string|number|undefined} value
 * @param {string} [flagName]  name for the error message (default: 'limit')
